...
#include <string.h>
#include <assert.h>
// Change to modified map file later
#include "Map.h"
#include "Places.h"
...
static int isRoadLink(int type[]);
static int isRailLink(int type[]);
static int isBoatLink(int type[]);
